...
function renderChart (data, container, scores, ratio) {
  ...
  svg
    .selectAll('circle')
    .data(scores.filter(function (score) { return _.find(cut_scores, {test: score.test}); }))
    .enter()
    .append('circle')
      .attr('r', 10)
      .attr('cx', function (d) {
...
exports.mergeCutsAndScores = mergeCutsAndScores;
